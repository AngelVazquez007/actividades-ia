...
// Variables numéricas/binarizadas
P_age     = X_raw(1,:);           // A1: edad
P_bin_sex = X_raw(2,:);           // A2: sexo
P_trest   = X_raw(4,:);           // A4: trestbps
P_chol    = X_raw(5,:);           // A5: colesterol
P_fbs     = X_raw(6,:);           // A6: fbs
P_thalach = X_raw(8,:);           // A8: thalach
P_exang   = X_raw(9,:);           // A9: exang
P_oldpeak = X_raw(10,:);          // A10: oldpeak

// One‑hot para los demás atributos
...
// Concatenamos todas las características en P
P = [ P_age;
      P_bin_sex;
      P_cp;
      P_trest;
...
///////////////////////////////////////////////////////
// 4. Normalización de entradas (media 0, varianza 1)
///////////////////////////////////////////////////////
disp("4. Normalizando entradas...");
mu_vec    = mean(P, 2);
sigma_vec = stdev(P, 'c');
// Evitar varianza cero
zero_idx = find(sigma_vec == 0);
if ~isempty(zero_idx) then
    sigma_vec(zero_idx) = 1;
end
...
///////////////////////////////////////////////////////
// 5. Preparar target T (0 = sano, 1 = enfermo)
///////////////////////////////////////////////////////
disp("5. Codificando targets...");
T = zeros(2, nSamp);
T(1, y_raw == 0) = 1;   // sano
...
///////////////////////////////////////////////////////
// 8. Predicciones individuales
///////////////////////////////////////////////////////
disp("8. Predicciones por muestra:");
for i = 1:nSamp
    // pred(i)==1 → sano, pred(i)==2 → enfermo
    if pred(i) == 1 then
        estado_pred = "sano";
    else
        estado_pred = "enfermo";
    ...
    disp("  Muestra " + string(i) + ...
         ": real=" + estado_real + ...
         ", predicha=" + estado_pred);
end
